...
void GPIO_Configuration(void)
{
  ...
  //aven GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_OD;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;
  GPIO_Init(I2C_MEMS_GPIO, &GPIO_InitStructure);  
  
  // Enable the GPIO_CS Clock
  //aven RCC_APB2PeriphClockCmd(CS_GPIO_CLK, ENABLE);
	RCC_APB2PeriphClockCmd(RCC_APB1Periph_I2C1, ENABLE);

  /* Configure the GPIO_CS pin */
  //aven GPIO_InitStructure.GPIO_Pin = CS_GPIO_PIN;
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8;
  //aven GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;

  //aven GPIO_Init(CS_GPIO_PORT, &GPIO_InitStructure);
