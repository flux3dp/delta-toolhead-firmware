...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
static GPIO_PinTypeDef ArduinoPort[32] = {
	{GPIO_Pin_11,GPIOA,NOT_CONFIGURED,0},
  {GPIO_Pin_7,GPIOA,NOT_CONFIGURED,0}, //ID1 	1
  {GPIO_Pin_6,GPIOA,NOT_CONFIGURED,0},//ID0   2
  ...
  {GPIO_Pin_2,GPIOA,NOT_CONFIGURED,0},
	{GPIO_Pin_1,GPIOA,NOT_CONFIGURED,0}, //TEMP  7
	{GPIO_Pin_0,GPIOA,NOT_CONFIGURED,0}, //THERM 8 
  {GPIO_Pin_14,GPIOB,NOT_CONFIGURED,0}, //F2FB	9
  {GPIO_Pin_13,GPIOB,NOT_CONFIGURED,0}, //HEATER 10
  {GPIO_Pin_12,GPIOB,NOT_CONFIGURED,0}, //F1FB    11
  {GPIO_Pin_11,GPIOB,NOT_CONFIGURED,0},
	{GPIO_Pin_10,GPIOB,NOT_CONFIGURED,0},
	{GPIO_Pin_9,GPIOB,NOT_CONFIGURED,0}, //FAN2 14
  {GPIO_Pin_8,GPIOB,NOT_CONFIGURED,0}, //FAN1 15
	{GPIO_Pin_7,GPIOB,NOT_CONFIGURED,0}, //SDA  16 PB7
  {GPIO_Pin_6,GPIOB,NOT_CONFIGURED,0}, //SCL  17 PB6
  {GPIO_Pin_5,GPIOB,NOT_CONFIGURED,0}, //INT2 18
  {GPIO_Pin_4,GPIOB,NOT_CONFIGURED,0}, //INT1 19
  {GPIO_Pin_3,GPIOB,NOT_CONFIGURED,0},
	{GPIO_Pin_2,GPIOB,NOT_CONFIGURED,0}, //LED1  21
  {GPIO_Pin_1,GPIOB,NOT_CONFIGURED,0}, //IO1   22
  {GPIO_Pin_0,GPIOB,NOT_CONFIGURED,0}, //IO0	 23
  {GPIO_Pin_0,GPIOC,NOT_CONFIGURED,0}, 
  {GPIO_Pin_1,GPIOC,NOT_CONFIGURED,0}, 
  {GPIO_Pin_2,GPIOC,NOT_CONFIGURED,0}, 
  {GPIO_Pin_8,GPIOC,NOT_CONFIGURED,0}, //LD4 27
  {GPIO_Pin_9,GPIOC,NOT_CONFIGURED,0}, //LD3 28
  {GPIO_Pin_5,GPIOC,NOT_CONFIGURED,0}, 
  {GPIO_Pin_7,GPIOF,NOT_CONFIGURED,0}, 
  {GPIO_Pin_8,GPIOF,NOT_CONFIGURED,0}, 
};
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
...
static void pinConfig(uint16_t pin, uint16_t mode){
 ...
 /* 
  ...
  if(!(L_oldType & 0x0001) && (mode & 0x0001) && (L_oldType != NOT_CONFIGURED)) { 
    ...
    if((pin == 3)||(pin == 5)||(pin == 6)||(pin == 9)||(pin == 10)||(pin == 11) ||(pin == 12) ||(pin == 13)) {
...
*/
  ...
  GPIO_InitStructure.GPIO_Pin = ArduinoPort[pin].PinNum;
	...
	//printf("\r\n pin %d",pin);
	//printf("\r\n GPIO %d",GPIO_InitStructure.GPIO_Pin);
...
uint16_t analogRead(uint16_t pin){
  ...
  switch(pin){
      //pin to configure or to get value from
		  ...
		  case 8:
              ...
              L_adcChannel = ADC_Channel_0;
              break; 

      case 2:
				      //printf("\r\n ID0");
              GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;
              L_adcChannel = ADC_Channel_6;
              break;

      case 1:
				      //printf("\r\n ID1");
              GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7;
              L_adcChannel = ADC_Channel_7;
              break;			
  ...
  //Pin was not correctly configured! Do it first!
    ...
    ADC_StructInit(&ADC_InitStructure);
		...
		ADC_InitStructure.ADC_Resolution = ADC_Resolution_10b;//aven
		
    ADC_InitStructure.ADC_ContinuousConvMode = ENABLE; 
    /* GPIOA config for ADC */
    RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOA, ENABLE);
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AN;
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL ;
    //Config pin as AN    
...
void analogWrite(uint16_t pin, uint16_t value){
  ...
  //Pin was not correctly configured! Do it first!
	...
	//ChannelPulse = (uint16_t) (((uint32_t) value * (TimerPeriod - 1)) / 100);
	//ChannelPulse = (uint16_t) (((uint32_t) value * (TimerPeriod - 1)) / 255);
	//value = (SystemCoreClock/732) * value;
   ...
   switch(pin){
      ...
      case 10:
        TIM1->ARR = ArduinoPort[pin].pwmPeriod;
			  //printf("\r\n pwm : %d ,%d",pin,ArduinoPort[pin].pwmPeriod);
      ...
      case 13:
        TIM2->ARR = ArduinoPort[pin].pwmPeriod;
			...
			case 14:
        TIM17->ARR = ArduinoPort[pin].pwmPeriod;
			  //printf("\r\n freq : %d",ArduinoPort[pin].pwmPeriod);
